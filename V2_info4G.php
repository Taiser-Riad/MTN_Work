...
<head>
    ...
    <title>MTN Syria | 4G Site Information</title>
...
<body>
    ...
    <div class="site-header">
        <div class="container">
            ...
            <div class="site-subtitle">4G LTE Site Details</div>
        </div>
    </div>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" onsubmit="window.close();">
            ...
            <div class="info-card">
                    ...
                    <table class="info-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><strong>4G On Air Date</strong></td>
                                <td><?php echo $row['ACTIVATION_DATE']; ?></td>
                            </tr>
                            <tr>
                                <td><strong>eNodeB ID</strong></td>
                                <td><?php echo $row['ENODEB_ID']; ?></td>
                            ...
                            <tr>
                                ...
                                <td><strong>Restoration Date</strong></td>
                ...
                <div class="notes-section">
                    ...
                    <div class="notes-content"><?php echo $row['NOTE'] ? $row['NOTE'] : 'No notes available'; ?></div>
                </div>
            </div>
            ...
            <div class="info-card">
                ...
                <div class="table-container">
                    <table class="info-table">
                        ...
                        <tbody>
                            <?php 
                            $cellCodes = ['A','B','C','D','X','Y','Z','W','V','E','J','K','L'];
                            foreach ($cellCodes as $cellcode_char) {
