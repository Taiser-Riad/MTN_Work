        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="form1">
                ...
                <div>
                    ...
                    <input type="text" name="sitecode" size="7" id="code" disabled
                ...
                <div>
                    ...
                    <input type="text" name="sitename" size="33" id="name" disabled
                        value="<?php echo $row['SITE_NAME'] ?>"></br></br>
                </div>
                <div>
                    <label for="name">Zone:</label>
                    <input type="text" name="Zone" size="33" id="name" disabled
                        value="<?php echo $row['ZONE'] ?>"></br></br>
                </div>
                <div>
                    <label for="name">Province:</label>
                    <input type="text" name="province" size="33" id="name" disabled
...
?>
                ...
                <div>
                    City /Rural: <input type="text" id="city" name="C/R" disabled
                        value="<?php echo $row['CR'];?>"></br></br>
                </div>
                <?php 
$checked1 = [];
...
?>
                ...
                <div>
                    ...
                    Supplier: <input type="text" id="erc" name="supplier" v disabled
                        value="<?php echo $row['SUPPLIER'] ;?>"></br></br>
                </div>
                <div>
                    <label for="power">Power Backup:</label>
                    <input type="text" name="powerbackup" size="50" id="power" disabled
                ...
                <div>
                    Invoice Topology: <select name="invoice" disabled>
                        ...
                        <option value="Tower / Generator / Solar and or TX Repeater"
                            <?php if($row['INVOICE_TYOLOGY'] == "Tower / Generator / Solar and or TX Repeater") echo 'Selected' ;?>>
                            Tower / Generator / Solar and or TX Repeater</option>
                        <option value="PTS Shelter / Indoor shelter and or TX node"
                            <?php if($row['INVOICE_TYOLOGY'] == "PTS Shelter / Indoor shelter and or TX node")  echo 'Selected' ;?>>
                            PTS Shelter / Indoor shelter and or TX node</option>
                        <option value="Other"
                            <?php if($row['INVOICE_TYOLOGY'] == "Other")                                        echo 'Selected' ;?>>
                            Others</option>
                    </select>
                    </br></br>
                </div>
