...
?>
    ...
    <input type ="text"      name="cnotesa"    placeholder="Note"                  value = "<?= $data['A']['NOTE']?? '' ?>">
...
<div>
    ...
    <input type ="text"      name="cnotesb"    placeholder="Note"                  value = "<?= $data['B']['NOTE']?? '' ?>">
...
<div>
    ...
    <input type ="text"      name="cnotesc"    placeholder="Note"                  value = "<?= $data['C']['Note']?? '' ?>">
...
<div>
    ...
    <input type ="text"      name="cnotesd"    placeholder="Note"                  value = "<?= $data['D']['NOTE']?? '' ?>">
...
<div>
    ...
    <input type ="text"      name="area1x"    size="30" placeholder="Arabic Serving Area"   value = "<?= $data['X']['SERVING_AREA']?? '' ?>">
    <input type ="text"      name="area2x"    size="30" placeholder="English Serving Area"  value = "<?= $data['X']['SERVING_AREA_IN_ENGLISH']?? '' ?>"></br></br>
    <input type ="text"      name="cnotesx"    placeholder="Note"                  value = "<?= $data['X']['Note']?? '' ?>">
...
<div>
    ...
    <input type ="text"      name="area1y"    size="30" placeholder="Arabic Serving Area"   value = "<?= $data['Y']['SERVING_AREA']?? '' ?>">
    <input type ="text"      name="area2y"    size="30" placeholder="English Serving Area"  value = "<?= $data['Y']['SERVING_AREA_IN_ENGLISH']?? '' ?>"></br></br>
    <input type ="text"      name="cnotesy"    placeholder="Note"                  value = "<?= $data['Y']['NOTE']?? '' ?>">
...
<div>
    ...
    <input type ="text"      name="area1z"    size="30" placeholder="Arabic Serving Area"   value = "<?= $data['Z']['SERVING_AREA']?? '' ?>">
    <input type ="text"      name="area2z"    size="30" placeholder="English Serving Area"  value = "<?= $data['Z']['SERVING_AREA_IN_ENGLISH']?? '' ?>"></br></br>
    <input type ="text"      name="cnotesz"    placeholder="Note"                  value = "<?= $data['Z']['NOTE']?? '' ?>">
...
<div>
    ...
    <input type ="text"      name="area1w"    size="30" placeholder="Arabic Serving Area"   value = "<?= $data['W']['SERVING_AREA']?? '' ?>">
    <input type ="text"      name="area2w"    size="30" placeholder="English Serving Area"  value = "<?= $data['W']['SERVING_AREA_IN_ENGLISH']?? '' ?>"></br></br>
    <input type ="text"      name="cnotesw"    placeholder="Note"                  value = "<?= $data['W']['NOTE']?? '' ?>">
...
<div>
    ...
    <input type ="text"      name="area1v"    size="30" placeholder="Arabic Serving Area"   value = "<?= $data['V']['SERVING_AREA']?? '' ?>">
    <input type ="text"      name="area2v"    size="30" placeholder="English Serving Area"  value = "<?= $data['V']['SERVING_AREA_IN_ENGLISH']?? '' ?>"></br></br>
    <input type ="text"      name="cnotesv"    placeholder="Note"                  value = "<?= $data['V']['NOTE']?? '' ?>">
...
<div>
    ...
    <input type ="text"      name="cnotese"    placeholder="Note"                  value = "<?= $data['E']['NOTE']?? '' ?>">
