...
<body>
    <div class="container">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
            ...
            ?>
                <input type="radio" id="option1" name="band" value="900" disabled
                    checked="<?php echo $checked[0];?>">900
                <input type="radio" id="option2" name="band" value="1800" disabled
                    checked="<?php echo $checked[0];?>">1800
                <input type="radio" id="option3" name="band" value="900/1800" disabled
                ...
                <div>
                    ...
                    <select name="900Rbs" disabled>
                        ...
                        <option value="BTS3900L" <?php if($row['NINTY_GSM_RBS_TYPE'] == "BTS3900L")echo 'Selected' ;?>>
                            BTS3900L</option>
                        <option value="6102" <?php if($row['NINTY_GSM_RBS_TYPE'] == "6102")    echo 'Selected' ;?>>6102
                        </option>
                        <option value="6130" <?php if($row['NINTY_GSM_RBS_TYPE'] == "6130")    echo 'Selected' ;?>>6130
                        </option>
                        <option value="6150" <?php if($row['NINTY_GSM_RBS_TYPE'] == "6150")    echo 'Selected' ;?>>6150
                        </option>
                        <option value="6201" <?php if($row['NINTY_GSM_RBS_TYPE'] == "6201")    echo 'Selected' ;?>>6201
                        </option>
                        <option value="6301" <?php if($row['NINTY_GSM_RBS_TYPE'] == "6301")    echo 'Selected' ;?>>6301
                        </option>
                        <option value="2109" <?php if($row['NINTY_GSM_RBS_TYPE'] == "2109")    echo 'Selected' ;?>>2109
                        </option>
                        <option value="2111" <?php if($row['NINTY_GSM_RBS_TYPE'] == "2111")    echo 'Selected' ;?>>2111
                        </option>
                        <option value="2116" <?php if($row['NINTY_GSM_RBS_TYPE'] == "2116")    echo 'Selected' ;?>>2116
                        </option>
                        <option value="2206" <?php if($row['NINTY_GSM_RBS_TYPE'] == "2206")    echo 'Selected' ;?>>2206
                        </option>
                        <option value="2216" <?php if($row['NINTY_GSM_RBS_TYPE'] == "2216")    echo 'Selected' ;?>>2216
                        </option>
                        <option value="2302" <?php if($row['NINTY_GSM_RBS_TYPE'] == "2302")    echo 'Selected' ;?>>2302
                        </option>
                        <option value="2308" <?php if($row['NINTY_GSM_RBS_TYPE'] == "2308")    echo 'Selected' ;?>>2308
                        </option>
                    ...
                    <input type="text" name="900onairdate" size="15" id="air date1" disabled
                ...
                <div>
                    ...
                    <select name="1800Rbs" disabled>
                        ...
                        <option value="BTS3900L" <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "BTS3900L")echo 'Selected' ;?>>
                            BTS3900L</option>
                        <option value="6102" <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "6102")    echo 'Selected' ;?>>6102
                        </option>
                        <option value="6130" <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "6130")    echo 'Selected' ;?>>6130
                        </option>
                        <option value="6150" <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "6150")    echo 'Selected' ;?>>6150
                        </option>
                        <option value="6201" <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "6201")    echo 'Selected' ;?>>6201
                        </option>
                        <option value="6301" <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "6301")    echo 'Selected' ;?>>6301
                        </option>
                        <option value="2109" <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "2109")    echo 'Selected' ;?>>2109
                        </option>
                        <option value="2111" <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "2111")    echo 'Selected' ;?>>2111
                        </option>
                        <option value="2116" <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "2116")    echo 'Selected' ;?>>2116
                        </option>
                        <option value="2206" <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "2206")    echo 'Selected' ;?>>2206
                        </option>
                        <option value="2216" <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "2216")    echo 'Selected' ;?>>2216
                        </option>
                        <option value="2302" <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "2302")    echo 'Selected' ;?>>2302
                        </option>
                        <option value="2308" <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "2308")    echo 'Selected' ;?>>2308
                        </option>
                    ...
                    <input type="text" name="1800onairdate" size="15" id="air date2" disabled
                ...
                <div>
                    ...
                    <input type="text" name="realBSC" size="15" id="RBSC" disabled
...
foreach (['A','B','C','X','Y','Z','D','W','V','E'] as $letter) : ?>
                ...
                <div>
                    ...
                    <input type="text" name="BSIC" size="3" placeholder="BSIC" disabled
                        value="<?= $data[$letter]['BSIC']?? '' ?>">
                    <input type="text" name="BCCH" size="3" placeholder="BCCH" disabled
