        ...
        <div class="search-form">
            <form method="POST">
                <div class="search-container">
                    <input type="text" class="search-input" name="search" placeholder="Enter site code (e.g., DAM123)" required>
                ...
                <div class="result-section">
                    ...
                    <div class="info-card">
                        ...
                        <div class="button-group">
                            <?php if($dep == 'Power'): ?>
                                <a href="addpower.php?id=<?php echo $row['ID']; ?>&user_id=<?php echo $user_id; ?>" class="btn btn-primary">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php else: ?>
                                            <a href="update2G.php?id2=<?php echo $roww['SITE_ID']; ?>" class="action-link update">
                                                <i class="fas fa-edit"></i> <span>Update</span>
                                            </a>
                                            <a href="delete2Gcellquest.php?id2=<?php echo $roww['CELL_CODE']; ?>" class="action-link delete">
                                                <i class="fas fa-trash"></i> <span>Delete</span>
                                            </a>
                                        <?php endif; ?>
                                    </td>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php else: ?>
                                            <a href="update3G.php?id3=<?php echo $roww2['SITE_ID']; ?>" class="action-link update">
                                                <i class="fas fa-edit"></i> <span>Update</span>
                                            </a>
                                            <a href="delete3Gcellquest.php?id3=<?php echo $roww2['CELL_CODE']; ?>" class="action-link delete">
                                                <i class="fas fa-trash"></i> <span>Delete</span>
                                            </a>
                                        <?php endif; ?>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <a href="delete4Gcellquest.php?id4=<?php echo $roww3['CELL_CODE']; ?>" class="action-link delete">
                                                <i class="fas fa-trash"></i> <span>Delete</span>
                                            </a>
                                        <?php endif; ?>
                                    </td>
