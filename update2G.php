...
<body >
    <div class="container">
        ...
        <div>
            ...
            <input type ="radio" id= "option2"  name="band" value="1800"    checked="<?php echo $checked[1];?>">1800
            <input type ="radio" id= "option3"  name="band" value="900/1800"checked="<?php echo $checked[2];?>">900/1800</br></br>

            <div>
    <label for="air date">2G On Air Date:</label>
    <input type ="text" name="onairdate" size="15" id="air date" value="<?php echo $row['TWOG_ON_AIR_DATE']; ?>"></br></br>
</div>
...
Site Status: <select name="sitestatus">
        ...
        <option value="Empty">--</option>
        <option value="On Air"              <?php if($row['SITE_STATUS'] == "On Air")             echo 'Selected' ;?>>On Air </option>
        <option value="On Air (Stopped)"    <?php if($row['SITE_STATUS'] == "On Air (Stopped)")   echo 'Selected' ;?>>On Air (Stopped)  </option>
        <option value="On Air (Stopped_2)"  <?php if($row['SITE_STATUS'] == "On Air (Stopped_2)") echo 'Selected' ;?>>On Air (Stopped_2)</option>
        </select>
    </br></br>
</div>
...
<div>
    ...
    <select name="900Rbs"> 
        <option value="">--</option>       
        <option value="BTS5900"     <?php if($row['NINTY_GSM_RBS_TYPE'] == "BTS5900")     echo 'Selected' ;?>>BTS5900</option>
        ...
        <option value="6102/RRUS"   <?php if($row['NINTY_GSM_RBS_TYPE'] == "6102/RRUS")   echo 'Selected' ;?>>6102/RRUS</option>
        <option value="6102/RUS"    <?php if($row['NINTY_GSM_RBS_TYPE'] == "6102/RUS")    echo 'Selected' ;?>>6102/RUS</option>
        <option value="6102_V2"     <?php if($row['NINTY_GSM_RBS_TYPE'] == "6102_V2")     echo 'Selected' ;?>>6102_V2</option>
        <option value="6102/RUG"    <?php if($row['NINTY_GSM_RBS_TYPE'] == "6102/RUG")    echo 'Selected' ;?>>6102/RUG</option>
        <option value="6102\RRUS"   <?php if($row['NINTY_GSM_RBS_TYPE'] == "6102\RRUS")   echo 'Selected' ;?>>6102\RRUS</option>
        <option value="6102W"       <?php if($row['NINTY_GSM_RBS_TYPE'] == "6102W")       echo 'Selected' ;?>>6102W</option>
        <option value="2206"        <?php if($row['NINTY_GSM_RBS_TYPE'] == "2206")        echo 'Selected' ;?>>2206</option>
        <option value="2206_V1"     <?php if($row['NINTY_GSM_RBS_TYPE'] == "2206_V1")     echo 'Selected' ;?>>2206_V1</option>
        <option value="2206_V2"     <?php if($row['NINTY_GSM_RBS_TYPE'] == "2206_V2")     echo 'Selected' ;?>>2206_V2</option>
        <option value="2216"        <?php if($row['NINTY_GSM_RBS_TYPE'] == "2216")        echo 'Selected' ;?>>2216</option>
        <option value="2216_V2"     <?php if($row['NINTY_GSM_RBS_TYPE'] == "2216_V2")     echo 'Selected' ;?>>2216_V2</option>
        <option value="6150"        <?php if($row['NINTY_GSM_RBS_TYPE'] == "6150")        echo 'Selected' ;?>>6150</option>
        <option value="6150/RUS"    <?php if($row['NINTY_GSM_RBS_TYPE'] == "6150/RUS")    echo 'Selected' ;?>>6150/RUS</option>
        <option value="6201"        <?php if($row['NINTY_GSM_RBS_TYPE'] == "6201")        echo 'Selected' ;?>>6201</option>
        <option value="6201_V2"     <?php if($row['NINTY_GSM_RBS_TYPE'] == "6201_V2")     echo 'Selected' ;?>>6201_V2</option>
        <option value="6201\DUG"    <?php if($row['NINTY_GSM_RBS_TYPE'] == "6201\DUG")    echo 'Selected' ;?>>6201\DUG</option>
        <option value="6201/RUS"    <?php if($row['NINTY_GSM_RBS_TYPE'] == "6201/RUS")    echo 'Selected' ;?>>6201/RUS</option>
        <option value="6201V2/RUS"  <?php if($row['NINTY_GSM_RBS_TYPE'] == "6201V2/RUS")  echo 'Selected' ;?>>6201V2/RUS</option>
        <option value="6301"        <?php if($row['NINTY_GSM_RBS_TYPE'] == "6301")        echo 'Selected' ;?>>6301</option>
        <option value="6301/RRUS"   <?php if($row['NINTY_GSM_RBS_TYPE'] == "6301/RRUS")   echo 'Selected' ;?>>6301/RRUS</option>
        ...
        <option value="6601"        <?php if($row['NINTY_GSM_RBS_TYPE'] == "6601")        echo 'Selected' ;?>>6601</option>
        <option value="6601/RRUS"   <?php if($row['NINTY_GSM_RBS_TYPE'] == "6601/RRUS")   echo 'Selected' ;?>>6601/RRUS</option>
    ...
    <input type ="text" name="900onairdate"  size="15" id="air date1" value="<?php echo $row['NINTY_ON_AIR_DATE']; ?>"></br></br>
</div>
    ...
    <option value="">--</option>       
        <option value="BTS5900"     <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "BTS5900")     echo 'Selected' ;?>>BTS5900</option>
        ...
        <option value="6102/RRUS"   <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "6102/RRUS")   echo 'Selected' ;?>>6102/RRUS</option>
        <option value="6102/RUS"    <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "6102/RUS")    echo 'Selected' ;?>>6102/RUS</option>
        <option value="6102_V2"     <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "6102_V2")     echo 'Selected' ;?>>6102_V2</option>
        <option value="6102/RUG"    <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "6102/RUG")    echo 'Selected' ;?>>6102/RUG</option>
        <option value="6102\RRUS"   <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "6102\RRUS")   echo 'Selected' ;?>>6102\RRUS</option>
        <option value="6102W"       <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "6102W")       echo 'Selected' ;?>>6102W</option>
        <option value="2206"        <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "2206")        echo 'Selected' ;?>>2206</option>
        <option value="2206_V1"     <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "2206_V1")     echo 'Selected' ;?>>2206_V1</option>
        <option value="2206_V2"     <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "2206_V2")     echo 'Selected' ;?>>2206_V2</option>
        <option value="2216"        <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "2216")        echo 'Selected' ;?>>2216</option>
        <option value="2216_V2"     <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "2216_V2")     echo 'Selected' ;?>>2216_V2</option>
        <option value="6150"        <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "6150")        echo 'Selected' ;?>>6150</option>
        <option value="6150/RUS"    <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "6150/RUS")    echo 'Selected' ;?>>6150/RUS</option>
        <option value="6201"        <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "6201")        echo 'Selected' ;?>>6201</option>
        <option value="6201_V2"     <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "6201_V2")     echo 'Selected' ;?>>6201_V2</option>
        <option value="6201\DUG"    <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "6201\DUG")    echo 'Selected' ;?>>6201\DUG</option>
        <option value="6201/RUS"    <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "6201/RUS")    echo 'Selected' ;?>>6201/RUS</option>
        <option value="6201V2/RUS"  <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "6201V2/RUS")  echo 'Selected' ;?>>6201V2/RUS</option>
        <option value="6301"        <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "6301")        echo 'Selected' ;?>>6301</option>
        <option value="6301/RRUS"   <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "6301/RRUS")   echo 'Selected' ;?>>6301/RRUS</option>
        ...
        <option value="6601"        <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "6601")        echo 'Selected' ;?>>6601</option>
        <option value="6601/RRUS"   <?php if($row['EIGHTY_GSM_RBS_TYPE'] == "6601/RRUS")   echo 'Selected' ;?>>6601/RRUS</option>

    </select>
    </br></br>

    <label for="air date2">1800 On Air Date:</label>
    <input type ="text" name="1800onairdate" size="15"  id="air date2" value="<?php echo $row['EIGHTY_ON_AIR_DATE']; ?>"></br></br>    
    </div>
...
<div>
    ...
    BSC:   <select name="BSC">    
                ...
                <option value="Empty">--</option>  
                <option value="EVOBSC1" <?php if($row['BSC'] == "EVOBSC1")    echo 'Selected' ;?>>EVOBSC1</option>
                <option value="EVOBSC2" <?php if($row['BSC'] == "EVOBSC2")    echo 'Selected' ;?>>EVOBSC2</option>
                <option value="EVOBSC4" <?php if($row['BSC'] == "EVOBSC4")    echo 'Selected' ;?>>EVOBSC4</option>
                <option value="EVOBSC5" <?php if($row['BSC'] == "EVOBSC5")    echo 'Selected' ;?>>EVOBSC5</option>
                <option value="EVOBSC6" <?php if($row['BSC'] == "EVOBSC6")    echo 'Selected' ;?>>EVOBSC6</option>
                <option value="EVOBSC9" <?php if($row['BSC'] == "EVOBSC9")    echo 'Selected' ;?>>EVOBSC9</option>
                <option value="HDBSC1" <?php if($row['BSC'] == "HDBSC1")    echo 'Selected' ;?>> HDBSC1 </option>
                <option value="HDBSC2" <?php if($row['BSC'] == "HDBSC2")    echo 'Selected' ;?>> HDBSC2 </option>
                <option value="HBSC1" <?php if($row['BSC'] == "HBSC2")    echo 'Selected' ;?>>  HBSC2  </option>
                <option value="HBSC4" <?php if($row['BSC'] == "HBSC4")    echo 'Selected' ;?>>  HBSC4  </option>
                <option value="HBSC7" <?php if($row['BSC'] == "HBSC7")    echo 'Selected' ;?>>  HBSC7  </option>
                <option value="HBSC8" <?php if($row['BSC'] == "HBSC8")    echo 'Selected' ;?>>  HBSC8  </option>
                <option value="HBSC10" <?php if($row['BSC'] == "HBSC10")    echo 'Selected' ;?>> HBSC10 </option>
                <option value="HBSC11" <?php if($row['BSC'] == "HBSC11")    echo 'Selected' ;?>> HBSC11 </option>
                <option value="HSKBSC2" <?php if($row['BSC'] == "HSKBSC2")    echo 'Selected' ;?>>HSKBSC2</option>
...
<div>
    ...
    <input type ="text" name="realBSC" size="15"  id="RBSC" value="<?php echo $row['REAL_BSC']; ?>"></br></br>
</div>
<div>
...
<div>
    ...
    <input type ="text" name="snotes" size="89"  id="note1" value="<?php echo $row['NOTES']; ?>"></br></br>
</div>
...
<div>
    ...
    <input type ="text"      name="area1a"    size="49" placeholder="Arabic Serving Area"   value = "<?= $data['A']['SERVING_AREA'] ?? '' ?>">
    <input type ="text"      name="area2a"    size="49" placeholder="English Serving Area"  value = "<?= $data['A']['SERVING_AREA_IN_ENGLISH']?? '' ?>"></br></br>
    <input type ="text"      name="cnotesa"   size="100" placeholder="Note"                  value = "<?= $data['A']['NOTE']?? '' ?>">
...
<div>
    ...
    <input type ="text"      name="celldateb" size="6"  placeholder="On Air Date"           value = "<?= $data['B']['CELL_ON_AIR_DATE']?? '' ?>" >
    <input type ="text"      name="heightb"   size="3"  placeholder="Height"                value = "<?= $data['B']['HIEGHT']?? '' ?>">
    ...
    <input type ="text"      name="area1b"    size="49" placeholder="Arabic Serving Area"   value = "<?= $data['B']['SERVING_AREA']?? '' ?>">
    <input type ="text"      name="area2b"    size="49" placeholder="English Serving Area"  value = "<?= $data['B']['SERVING_AREA_IN_ENGLISH']?? '' ?>"></br></br>
    <input type ="text"      name="cnotesb"   size="100" placeholder="NOTE"                  value = "<?= $data['B']['NOTE']?? '' ?>">
...
<div>
    ...
    <input type ="text"      name="celldatec" size="6"  placeholder="On Air Date"           value = "<?= $data['C']['CELL_ON_AIR_DATE']?? '' ?>" >
    <input type ="text"      name="heightc"   size="3"  placeholder="Height"                value = "<?= $data['C']['HIEGHT']?? '' ?>">
    ...
    <input type ="text"      name="area1c"    size="49" placeholder="Arabic Serving Area"   value = "<?= $data['C']['SERVING_AREA']?? '' ?>">
    <input type ="text"      name="area2c"    size="49" placeholder="English Serving Area"  value = "<?= $data['C']['SERVING_AREA_IN_ENGLISH']?? '' ?>"></br></br>
    <input type ="text"      name="cnotesc"   size="100" placeholder="Note"                  value = "<?= $data['C']['NOTE']?? '' ?>">
...
<div>
    ...
    <input type ="text"      name="celldated" size="6"  placeholder="On Air Date"           value = "<?= $data['D']['CELL_ON_AIR_DATE']?? '' ?>" >
    <input type ="text"      name="heightd"   size="3"  placeholder="Height"                value = "<?= $data['D']['HIEGHT']?? '' ?>">
    ...
    <input type ="text"      name="area1d"    size="49" placeholder="Arabic Serving Area"   value = "<?= $data['D']['SERVING_AREA']?? '' ?>">
    <input type ="text"      name="area2d"    size="49" placeholder="English Serving Area"  value = "<?= $data['D']['SERVING_AREA_IN_ENGLISH']?? '' ?>"></br></br>
    <input type ="text"      name="cnotesd"   size="100" placeholder="Note"                  value = "<?= $data['D']['NOTE']?? '' ?>">
...
<div>
    ...
    <input type = "checkbox" name="cell[]"     value="<?= 'X'?>" <?php if ( $data['X']) echo 'checked'; ?> ><?= 'X' ?>

    <input type ="text"      name="cellidx"   size="4"  placeholder="Cell ID"               value = "<?= $data['X']['CELL_ID']?? '' //echo cell_id and if it is null echo ''?>">
    <input type ="text"      name="cellcodex" size="5"  placeholder="Cell Code"             value = "<?= $data['X']['CELL_CODE']?? 'empty' ?>" >
    <input type ="text"      name="cellnamex" size="15"  placeholder="Cell Name"            value = "<?= $data['X']['CELL_NAME']?? 'woow' ?>" >
    <input type ="text"      name="azimuthx"  size="3"  placeholder="Azimuth"               value = "<?= $data['X']['AZIMUTH']?? '' ?>" >
    <input type ="text"      name="celldatex" size="6"  placeholder="On Air Date"           value = "<?= $data['X']['CELL_ON_AIR_DATE']?? '' ?>" >
    <input type ="text"      name="heightx"   size="3"  placeholder="Height"                value = "<?= $data['X']['HIEGHT']?? '' ?>">
    ...
    <input type ="text"      name="mtiltx"    size="3"  placeholder="M_TILT"                value = "<?= $data['X']['M_TILT']?? '' ?>">
    <input type ="text"      name="etiltx"    size="3"  placeholder="E_TILT"                value = "<?= $data['X']['E_TILT']?? '' ?>"></br>
    <input type ="text"      name="area1x"    size="49" placeholder="Arabic Serving Area"   value = "<?= $data['X']['SERVING_AREA']?? '' ?>">
    <input type ="text"      name="area2x"    size="49" placeholder="English Serving Area"  value = "<?= $data['X']['SERVING_AREA_IN_ENGLISH']?? '' ?>"></br></br>
    <input type ="text"      name="cnotesx"   size="100" placeholder="Note"                  value = "<?= $data['X']['NOTE']?? '' ?>">
...
<div>
    ...
    <input type = "checkbox" name="cell[]"     value="<?= 'Y' ?>" <?php if ( $data['Y']) echo 'checked'; ?> ><?= 'Y' ?>

    <input type ="text"      name="cellidy"   size="4"  placeholder="Cell ID"               value = "<?= $data['Y']['CELL_ID']?? '' //echo cell_id and if it is null echo ''?>">
    <input type ="text"      name="cellcodey" size="5"  placeholder="Cell Code"             value = "<?= $data['Y']['CELL_CODE']?? 'empty' ?>" >
    <input type ="text"      name="cellnamey" size="15"  placeholder="Cell Name"            value = "<?= $data['Y']['CELL_NAME']?? 'woow' ?>" >
    <input type ="text"      name="azimuthy"  size="3"  placeholder="Azimuth"               value = "<?= $data['Y']['AZIMUTH']?? '' ?>" >
    <input type ="text"      name="celldatey" size="6"  placeholder="On Air Date"           value = "<?= $data['Y']['CELL_ON_AIR_DATE']?? '' ?>" >
    <input type ="text"      name="heighty"   size="3"  placeholder="Height"                value = "<?= $data['Y']['HIEGHT']?? '' ?>">
    ...
    <input type ="text"      name="mtilty"    size="3"  placeholder="M_TILT"                value = "<?= $data['Y']['M_TILT']?? '' ?>">
    <input type ="text"      name="etilty"    size="3"  placeholder="E_TILT"                value = "<?= $data['Y']['E_TILT']?? '' ?>"></br>
    <input type ="text"      name="area1y"    size="49" placeholder="Arabic Serving Area"   value = "<?= $data['Y']['SERVING_AREA']?? '' ?>">
    <input type ="text"      name="area2y"    size="49" placeholder="English Serving Area"  value = "<?= $data['Y']['SERVING_AREA_IN_ENGLISH']?? '' ?>"></br></br>
    <input type ="text"      name="cnotesy"   size="100" placeholder="Note"                  value = "<?= $data['Y']['NOTE']?? '' ?>">
...
<div>
    ...
    <input type = "checkbox" name="cell[]"     value="<?= 'Z' ?>" <?php if ( $data['Z']) echo 'checked'; ?> ><?= 'Z' ?>

    <input type ="text"      name="cellidz"   size="4"  placeholder="Cell ID"               value = "<?= $data['Z']['CELL_ID']?? '' //echo cell_id and if it is null echo ''?>">
    <input type ="text"      name="cellcodez" size="5"  placeholder="Cell Code"             value = "<?= $data['Z']['CELL_CODE']?? '' ?>" >
    <input type ="text"      name="cellnamez" size="15"  placeholder="Cell Name"            value = "<?= $data['Z']['CELL_NAME']?? '' ?>" >
    <input type ="text"      name="azimuthz"  size="3"  placeholder="Azimuth"               value = "<?= $data['Z']['AZIMUTH']?? '' ?>" >
    <input type ="text"      name="celldatez" size="6"  placeholder="On Air Date"           value = "<?= $data['Z']['CELL_ON_AIR_DATE']?? '' ?>" >
    <input type ="text"      name="heightz"   size="3"  placeholder="Height"                value = "<?= $data['Z']['HIEGHT']?? '' ?>">
    ...
    <input type ="text"      name="mtiltz"    size="3"  placeholder="M_TILT"                value = "<?= $data['Z']['M_TILT']?? '' ?>">
    <input type ="text"      name="etiltz"    size="3"  placeholder="E_TILT"                value = "<?= $data['Z']['E_TILT']?? '' ?>"></br>
    <input type ="text"      name="area1z"    size="49" placeholder="Arabic Serving Area"   value = "<?= $data['Z']['SERVING_AREA']?? '' ?>">
    <input type ="text"      name="area2z"    size="49" placeholder="English Serving Area"  value = "<?= $data['Z']['SERVING_AREA_IN_ENGLISH']?? '' ?>"></br></br>
    <input type ="text"      name="cnotesz"   size="100" placeholder="Note"                  value = "<?= $data['Z']['NOTE']?? '' ?>">
...
<div>
    ...
    <input type = "checkbox" name="cell[]"     value="<?= 'w' ?>" <?php if ( $data['W']) echo 'checked'; ?> ><?= 'W' ?>

    <input type ="text"      name="cellidw"   size="4"  placeholder="Cell ID"               value = "<?= $data['W']['CELL_ID']?? '' //echo cell_id and if it is null echo ''?>">
    <input type ="text"      name="cellcodew" size="5"  placeholder="Cell Code"             value = "<?= $data['W']['CELL_CODE']?? 'empty' ?>" >
    <input type ="text"      name="cellnamew" size="15"  placeholder="Cell Name"            value = "<?= $data['W']['CELL_NAME']?? 'woow' ?>" >
    <input type ="text"      name="azimuthw"  size="3"  placeholder="Azimuth"               value = "<?= $data['W']['AZIMUTH']?? '' ?>" >
    <input type ="text"      name="celldatew" size="6"  placeholder="On Air Date"           value = "<?= $data['W']['CELL_ON_AIR_DATE']?? '' ?>" >
    <input type ="text"      name="heightw"   size="3"  placeholder="Height"                value = "<?= $data['W']['HIEGHT']?? '' ?>">
    ...
    <input type ="text"      name="mtiltw"    size="3"  placeholder="M_TILT"                value = "<?= $data['W']['M_TILT']?? '' ?>">
    <input type ="text"      name="etiltw"    size="3"  placeholder="E_TILT"                value = "<?= $data['W']['E_TILT']?? '' ?>"></br>
    <input type ="text"      name="area1w"    size="49" placeholder="Arabic Serving Area"   value = "<?= $data['W']['SERVING_AREA']?? '' ?>">
    <input type ="text"      name="area2w"    size="49" placeholder="English Serving Area"  value = "<?= $data['W']['SERVING_AREA_IN_ENGLISH']?? '' ?>"></br></br>
    <input type ="text"      name="cnotesw"   size="100" placeholder="Note"                  value = "<?= $data['W']['NOTE']?? '' ?>">
...
<div>
    ...
    <input type = "checkbox" name="cell[]"     value="<?= 'v' ?>" <?php if ( $data['V']) echo 'checked'; ?> ><?= 'V' ?>

    <input type ="text"      name="cellidv"   size="4"  placeholder="Cell ID"               value = "<?= $data['V']['Cell_ID']?? '' //echo cell_id and if it is null echo ''?>">
    <input type ="text"      name="cellcodev" size="5"  placeholder="Cell Code"             value = "<?= $data['V']['CELL_CODE']?? 'empty' ?>" >
    <input type ="text"      name="cellnamev" size="15"  placeholder="Cell Name"            value = "<?= $data['V']['CELL_NAME']?? 'woow' ?>" >
    <input type ="text"      name="azimuthv"  size="3"  placeholder="Azimuth"               value = "<?= $data['V']['AZIMUTH']?? '' ?>" >
    <input type ="text"      name="celldatev" size="6"  placeholder="On Air Date"           value = "<?= $data['V']['CELL_ON_AIR_DATE']?? '' ?>" >
    <input type ="text"      name="heightv"   size="3"  placeholder="Height"                value = "<?= $data['V']['HIEGHT']?? '' ?>">
    ...
    <input type ="text"      name="mtiltv"    size="3"  placeholder="M_TILT"                value = "<?= $data['V']['M_TILT']?? '' ?>">
    <input type ="text"      name="etiltv"    size="3"  placeholder="E_TILT"                value = "<?= $data['V']['E_TILT']?? '' ?>"></br>
    <input type ="text"      name="area1v"    size="49" placeholder="Arabic Serving Area"   value = "<?= $data['V']['SERVING_AREA']?? '' ?>">
    <input type ="text"      name="area2v"    size="49" placeholder="English Serving Area"  value = "<?= $data['V']['SERVING_AREA_IN_ENGLISH']?? '' ?>"></br></br>
    <input type ="text"      name="cnotesv"   size="100" placeholder="Note"                  value = "<?= $data['V']['NOTE']?? '' ?>">
...
<div>
    ...
    <input type ="text"      name="celldatee" size="6"  placeholder="On Air Date"           value = "<?= $data['E']['CELL_ON_AIR_DATE']?? '' ?>" >
    <input type ="text"      name="heighte"   size="3"  placeholder="Height"                value = "<?= $data['E']['HIEGHT']?? '' ?>">
    ...
    <input type ="text"      name="area1e"    size="49" placeholder="Arabic Serving Area"   value = "<?= $data['E']['SERVING_AREA']?? '' ?>">
    <input type ="text"      name="area2e"    size="49" placeholder="English Serving Area"  value = "<?= $data['E']['SERVING_AREA_IN_ENGLISH']?? '' ?>"></br></br>
    <input type ="text"      name="cnotese"   size="100" placeholder="Note"                  value = "<?= $data['E']['NOTE']?? '' ?>">
