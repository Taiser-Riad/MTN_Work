    ...
    <div class="container">
        <form id="powerConfigForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
            ...
            <div class="form-container">
                ...
                <div class="form-section">
                    ...
                    <div class="section-content">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="counter_breaker" name="counterbraker"
                ...
                <div class="form-section">
                    <div class="section-header expanded" data-section="cabinet">
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-group">
                                <div class="radio-item">
                                    <input type="radio" id="cabinet_cage_yes" name="cage" value="Yes">
                                    <label for="cabinet_cage_yes">Yes</label>
                                </div>
                                <div class="radio-item">
                                    <input type="radio" id="cabinet_cage_no" name="cage" value="No" checked>
                    ...
                    <div class="section-content">
                        ...
                        <div class="sub-options" id="generatorOptions">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="generator_qty" name="qty" min="1" value="1">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio-group">
                                    ...
                                    <div class="radio-item">
                                        <input type="radio" id="generator_cage_no" name="cage" value="No" checked>
                            ...
                            <div class="tank-grid">
                                <div class="tank-card">
                                    <h4>
                                        ...
                                        <span class="tank-toggle">
                                            <input type="checkbox" name="tank1" value="1"> Include
                                        </span>
                                    </h4>
                                ...
                                <div class="tank-card">
                                    <h4>
                                        ...
                                        <span class="tank-toggle">
                                            <input type="checkbox" name="tank2" value="1"> Include
                                        </span>
                                    </h4>
                                    <div class="tank-fields">
                                        <div class="form-group">
                                ...
                                <div class="tank-card">
                                    <h4>
                                        ...
                                        <span class="tank-toggle">
                                            <input type="checkbox" name="tank3" value="1"> Include
                                        </span>
                                    </h4>
                                    <div class="tank-fields">
                                        <div class="form-group">
                ...
                <div class="form-section">
                    ...
                    <div class="section-content">
                        ...
                        <div class="sub-options" id="solarOptions">
                            ...
                            <div class="form-group">
                                <label for="solar_status"><i class="fas fa-clipboard-check"></i> System Status</label>
                            ...
                            <div class="form-group">
                                <label for="solar_brand"><i class="fas fa-industry"></i> Brand Ownership</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="solar_panels_qty" name="panelqty" min="1" value="1">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="solar_modules_qty" name="solarmodqty" min="1" value="1">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="tank-grid">
                            <div class="tank-card">
                                <h4>
                                    ...
                                    <span class="tank-toggle">
                                        <input type="checkbox" name="B1Battaries" value="1"> Include
                                    </span>
                                </h4>
                                <div class="tank-fields">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="battery1_capacity"><i class="fas fa-charging-station"></i> Capacity
                                            (Ah)</label>
                            ...
                            <div class="tank-card">
                                <h4>
                                    ...
                                    <span class="tank-toggle">
                                        <input type="checkbox" name="B2Battaries" value="1"> Include
                                    </span>
                                </h4>
                                <div class="tank-fields">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="battery2_capacity"><i class="fas fa-charging-station"></i> Capacity
                                            (Ah)</label>
                    ...
                    <div class="section-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-group">
                                ...
                                <div class="radio-item">
                                    <input type="radio" id="site_cage_no" name="sitecage" value="No" checked>
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-group">
                                ...
                                <div class="radio-item">
                                    <input type="radio" id="site_guard_no" name="sitegurde" value="No" checked>
