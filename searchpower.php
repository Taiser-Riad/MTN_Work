...
<head>
    ...
    * {
    ...
    .no-data {
        background: linear-gradient(to right, #2c5282, rgb(103, 136, 175));
        text-align: center;
        padding: 20px;
        color: white;
        font-style: italic;
...
<body>
    <div class="container">
        ...
        <div class="results-container">
            ...
            <?php if(isset($sitecode) && $dep == 'Power'): ?>
            <div class="result-section">
                <div class="section-title">
                    <h2><i class="fas fa-bolt"></i> Power Backup Summary</h2>
                </div>
                ...
                <div class="table-container">
                    <table class="power-summary-table">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><?php echo $row_gen['INITIAL_STATUS'] ?? '-'; ?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                <?php else: ?>
                <div class="no-data">No Generator found</div>
                <?php endif; ?>
                    ...
                    <table class="power-summary-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><?php echo $row_hyp['STATUS'] ?? '-'; ?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                <?php else: ?>
                <div class="no-data">No Solar system found</div>
                <?php endif; ?>
                ...
                <div class="table-container">
                <h3 class="table-title">🔋 Batteries Info</h3>
                    <table class="power-summary-table">
                        <thead>
                            <tr>
                ...
                <?php else: ?>
                <div class="no-data">No Lines found</div>
                <?php endif; ?>
            </div>
            <?php endif; ?>
            <!-- END POWER SUMMARY SECTION -->
            ...
            <?php endif; // End non-Power department sections ?>
