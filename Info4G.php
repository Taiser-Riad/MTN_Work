...
<div>
    ...
    <input type ="text" name="nodeb" size="5" id="node" disabled value="<?php echo $row['ENODEB_ID']; ?>"></br></br>
</div>
...
<div>
    ...
    <input type ="text" name="onairdate" size="15" id="air date" disabled value="<?php echo $row['ACTIVATION_DATE']; ?>"></br></br>
</div>
...
<label for="note1">Site Notes:</label>
    <input type ="text" name="snotes" size="75" id="note1" disabled value="<?php echo $row['NOTE']; ?>"></br></br>
...
<div>
 ...
 <input type = "checkbox" name="cell[]"   disabled  value="<?= $letter ?>" <?php if ( $data[$letter]) echo 'checked'; ?> ><?= $letter ?>
    ...
    <input type ="text"      name="height"   size="3"  placeholder="Height"               disabled      value = "<?= $data[$letter]['HEIGHT']?? '' ?>">
    ...
    <input type ="text"      name="cnotes"   size="75" placeholder="Note"                 disabled      value = "<?= $data[$letter]['NOTES']?? '' ?>">
