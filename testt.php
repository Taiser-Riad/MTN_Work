...
<body >
    <div class="container">
        ...
        <div>
            ...
            <input type ="radio" id= "option3"  name="band" value="900/1800"checked="<?php echo $checked[0];?>">900/1800</br></br>

            <div>
    <label for="air date">2G On Air Date:</label>
    <input type ="text" name="onairdate" size="15" id="air date" value="<?php echo $row['2G_On_Air_Date']; ?>"></br></br>
</div>
...
<div>
    ...
    <select name="900Rbs"> 
        <option value="">--</option>       
        <option value="BTS3900"  <?php if($row['900GSM_RBS_Type'] == "BTS3900") echo 'Selected' ;?>>BTS3900</option>
        <option value="DBS3900"  <?php if($row['900GSM_RBS_Type'] == "DBS3900") echo 'Selected' ;?>>DBS3900</option>
        <option value="DBS5900"  <?php if($row['900GSM_RBS_Type'] == "DBS5900") echo 'Selected' ;?>>DBS5900</option>
        <option value="BTS3900A" <?php if($row['900GSM_RBS_Type'] == "BTS3900A")echo 'Selected' ;?>>BTS3900A</option>
        <option value="BTS3900L" <?php if($row['900GSM_RBS_Type'] == "BTS3900L")echo 'Selected' ;?>>BTS3900L</option>
        <option value="6102"     <?php if($row['900GSM_RBS_Type'] == "6102")    echo 'Selected' ;?>>6102</option>
        <option value="6130"     <?php if($row['900GSM_RBS_Type'] == "6130")    echo 'Selected' ;?>>6130</option>
        <option value="6150"     <?php if($row['900GSM_RBS_Type'] == "6150")    echo 'Selected' ;?>>6150</option>
        <option value="6201"     <?php if($row['900GSM_RBS_Type'] == "6201")    echo 'Selected' ;?>>6201</option>
        <option value="6301"     <?php if($row['900GSM_RBS_Type'] == "6301")    echo 'Selected' ;?>>6301</option>
        <option value="2109"     <?php if($row['900GSM_RBS_Type'] == "2109")    echo 'Selected' ;?>>2109</option>
        <option value="2111"     <?php if($row['900GSM_RBS_Type'] == "2111")    echo 'Selected' ;?>>2111</option>
        <option value="2116"     <?php if($row['900GSM_RBS_Type'] == "2116")    echo 'Selected' ;?>>2116</option>
        <option value="2206"     <?php if($row['900GSM_RBS_Type'] == "2206")    echo 'Selected' ;?>>2206</option>
        <option value="2216"     <?php if($row['900GSM_RBS_Type'] == "2216")    echo 'Selected' ;?>>2216</option>
        <option value="2302"     <?php if($row['900GSM_RBS_Type'] == "2302")    echo 'Selected' ;?>>2302</option>
        <option value="2308"     <?php if($row['900GSM_RBS_Type'] == "2308")    echo 'Selected' ;?>>2308</option>

    </select>
    </br></br>

    <label for="air date1">900 On Air Date:</label>
    <input type ="text" name="900onairdate"  size="15" id="air date1" value="<?php echo $row['900On_Air_Date']; ?>"></br></br>
</div>
    ...
    <select name="1800Rbs"> 
        ...
        <option value="">--</option>
        <option value="BTS3900"  <?php if($row['900GSM_RBS_Type']  == "BTS3900") echo 'Selected' ;?>>BTS3900</option>
        <option value="DBS3900"  <?php if($row['1800GSM_RBS_Type'] == "DBS3900") echo 'Selected' ;?>>DBS3900</option>
        <option value="DBS5900"  <?php if($row['1800GSM_RBS_Type'] == "DBS5900") echo 'Selected' ;?>>DBS5900</option>
        <option value="BTS3900A" <?php if($row['1800GSM_RBS_Type'] == "BTS3900A")echo 'Selected' ;?>>BTS3900A</option>
        <option value="BTS3900L" <?php if($row['1800GSM_RBS_Type'] == "BTS3900L")echo 'Selected' ;?>>BTS3900L</option>
        <option value="6102"     <?php if($row['1800GSM_RBS_Type'] == "6102")    echo 'Selected' ;?>>6102</option>
        <option value="6130"     <?php if($row['1800GSM_RBS_Type'] == "6130")    echo 'Selected' ;?>>6130</option>
        <option value="6150"     <?php if($row['1800GSM_RBS_Type'] == "6150")    echo 'Selected' ;?>>6150</option>
        <option value="6201"     <?php if($row['1800GSM_RBS_Type'] == "6201")    echo 'Selected' ;?>>6201</option>
        <option value="6301"     <?php if($row['1800GSM_RBS_Type'] == "6301")    echo 'Selected' ;?>>6301</option>
        <option value="2109"     <?php if($row['1800GSM_RBS_Type'] == "2109")    echo 'Selected' ;?>>2109</option>
        <option value="2111"     <?php if($row['1800GSM_RBS_Type'] == "2111")    echo 'Selected' ;?>>2111</option>
        <option value="2116"     <?php if($row['1800GSM_RBS_Type'] == "2116")    echo 'Selected' ;?>>2116</option>
        <option value="2206"     <?php if($row['1800GSM_RBS_Type'] == "2206")    echo 'Selected' ;?>>2206</option>
        <option value="2216"     <?php if($row['1800GSM_RBS_Type'] == "2216")    echo 'Selected' ;?>>2216</option>
        <option value="2302"     <?php if($row['1800GSM_RBS_Type'] == "2302")    echo 'Selected' ;?>>2302</option>
        <option value="2308"     <?php if($row['1800GSM_RBS_Type'] == "2308")    echo 'Selected' ;?>>2308</option>

    </select>
    </br></br>

    <label for="air date2">1800 On Air Date:</label>
    <input type ="text" name="1800onairdate" size="15"  id="air date2" value="<?php echo $row['1800On_Air_Date']; ?>"></br></br>    
    </div>
...
<div>
    ...
    <input type ="text" name="snotes" size="75"  id="note1" value="<?php echo $row['Notes']; ?>"></br></br>
</div>
...
<div>
    ...
    <input type = "checkbox" name="cell[]"     value="<?= $letter ?>" <?php if ( $data[$letter]) echo 'checked'; ?> ><?= $letter ?>

    <input type ="text"      name="cellid"   size="4"  placeholder="Cell ID"               value = "<?= $data[$letter]['Cell_ID']?? '' //echo cell_id and if it is null echo ''?>">
    <input type ="text"      name="cellcode" size="5"  placeholder="Cell Code"             value = "<?= $data[$letter]['Cell_code']?? 'empty' ?>" >
    <input type ="text"      name="cellname" size="15"  placeholder="Cell Name"            value = "<?= $data[$letter]['Cell_Name']?? 'woow' ?>" >
    <input type ="text"      name="azimuth"  size="3"  placeholder="Azimuth"               value = "<?= $data[$letter]['AZIMUTH']?? '' ?>" >
    <input type ="text"      name="celldate" size="6"  placeholder="On Air Date"           value = "<?= $data[$letter]['Cell_On_Air_Date']?? '' ?>" >
    <input type ="text"      name="height"   size="3"  placeholder="Height"                value = "<?= $data[$letter]['Hieght']?? '' ?>">
    <input type ="text"      name="BSIC"     size="3"  placeholder="BSIC"                  value = "<?= $data[$letter]['BSiC']?? '' ?>">
    <input type ="text"      name="BCCH"     size="3"  placeholder="BCCH"                  value = "<?= $data[$letter]['BCCH']?? '' ?>">
    <input type ="text"      name="mtilt"    size="3"  placeholder="M_TILT"                value = "<?= $data[$letter]['M_TILT']?? '' ?>">
    <input type ="text"      name="etilt"    size="3"  placeholder="E_TILT"                value = "<?= $data[$letter]['E_TILT']?? '' ?>"></br>
