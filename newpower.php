...
if(isset($_POST['submit'])){
    ...
    $check_sql = "SELECT COUNT(*) AS count FROM POWER_BACKUP WHERE SITE_CODE = :sitecode";
...
<div id="sub_main1" class="sub-options">
    ...
    <div id="sub_main11" class="sub-options">
      ...
      <label> Number Of MTN Generators:</label><br><input type="text" name="count" size="3"> <br></div>
