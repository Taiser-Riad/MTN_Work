...
<head>
    ...
    <title>MTN Syria | 3G Site Information</title>
...
<body>
    ...
    <div class="site-header">
        <div class="container">
            ...
            <div class="site-subtitle">3G Site Details</div>
        </div>
    </div>
                    ...
                    <table class="info-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><strong>3G On Air Date</strong></td>
                                <td><?php echo $row['THREE_G_ON_AIR_DATE']; ?></td>
                            </tr>
                            <tr>
                                <td><strong>WBTS ID</strong></td>
                            ...
                            <tr>
                                ...
                                <td><strong>Renovation Date</strong></td>
