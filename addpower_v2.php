        ...
        <form id="powerConfigForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
            ...
            <div class="search-form">
                ...
                <input type="hidden" name="username1" value="<?php echo $userrname; ?>">
                    <input type="text" class="search-input" name="searchcode" placeholder="Enter site code (e.g., DAM123)">
...
<input type="hidden" name="id" value="<?php echo $siteid; ?>">
                ...
                <div class="form-section">
                    ...
                    <div class="section-content" style="display: grid; grid-template-columns: repeat(3, 1fr);">
                        <div class="form-group">
                            ...
                            <div class="error-message" id="serialError">Serial number is required</div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select id="counter_status" name="cstatus">
                                <option value="">--</option>
                                <option value="Not Exsist">Not Exsist</option>
                        ...
                        <div class="form-group">
                            ...
                            <select id="counter_power" name="cpower">
                ...
                <div class="form-section">
                    ...
                    <div class="section-content" style="display: grid; grid-template-columns: repeat(3, 1fr);">
                        ...
                        <div class="form-group">
                            <label for="cabinet_notes"><i class="fas fa-sticky-note"></i> Notes</label>
                            <textarea id="cabinet_notes" name="cabnote" rows="3" placeholder="Additional cabinet notes"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="section-content">
                        ...
                        <div class="sub-options" id="generatorOptions">
                            ...
                            <div class="form-group">
                                <label for="generator_status"><i class="fas fa-clipboard-check"></i> Initial Status</label>
                            ...
                            <div class="form-group">
                                <label for="generator_status"><i class="fas fa-clipboard-check"></i> Current Status</label>
                            ...
                            <div class="form-group">
                                <label for="generator_capacity"><i class="fas fa-charging-station"></i> Capacity (kVA)</label>
                                <input type="text" id="generator_capacity" name="capacity" placeholder="Enter capacity">
                            </div>
                        ...
                        <div class="form-section" style="display: grid; grid-template-columns: repeat(1, 1fr);">
                            <div class="section-content">
                                <div class="tank-grid" style="display: grid; grid-template-columns: repeat(3, 2fr);">
                                    <!-- Tank cards here... -->
                                </div>
                            </div>
                        </div>
                ...
                <div class="form-section">
                    ...
                    <div class="section-content">
                        <div class="form-group">
                            <label> Hybrid/Solar Installed <span class="status-badge badge-inactive">Inactive</span></label>
                            <div class="checkbox-group">
                                <div class="checkbox-item">
                        ...
                        <div class="sub-options" id="solarOptions">
                            ...
                            <div class="form-group">
                                <label for="solar_status"><i class="fas fa-clipboard-check"></i> Solar Status</label>
                            ...
                            <div class="form-group">
                                <label for="solar_brand"><i class="fas fa-industry"></i> System Status</label>
                                <select id="solar_brand" name="solartype" disabled>
                                    <option value="--"> -- </option>
                            ...
                            <div class="form-group">
                                <label for="solar_panels_qty"><i class="fas fa-solar-panel"></i> Panels Quantity</label>
                                <input type="number" id="solar_panels_qty" name="panelqty" min="1">
                            </div>

                            <div class="form-group">
                                <label for="solar_panel_capacity"><i class="fas fa-battery-full"></i> Panel Capacity (W)</label>
                                <input type="number" id="solar_panel_capacity" name="solarcapacity" placeholder="Enter capacity">
                            </div>
                ...
                <div class="form-section">
                    ...
                    <div class="section-content">
                        <div class="form-group">
                            <label><i class="fas fa-bolt"></i> Ampere Backup <span class="status-badge badge-active">Active</span></label>
                            <div class="checkbox-group">
                                <div class="checkbox-item">
                                    <input type="checkbox" id="ampere_present" name="Ampere" value="1" checked>
                        ...
                        <div class="sub-options" id="ampereOptions">
                            <div class="form-group">
                                ...
                                <input type="number" id="ampere_capacity" name="ampcapacity" placeholder="Enter ampere capacity">
                            </div>

                            <div class="form-group">
                                <label for="ampere_duration"><i class="fas fa-clock"></i> Duration (hours)</label>
                                <input type="number" id="ampere_duration" name="ampduration" placeholder="Enter duration">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    // Solar Status Change Handler
    const handleSolarStatusChange = () => {
        const solarStatus = document.getElementById('solar_status').value;
        const systemStatus = document.getElementById('solar_brand');
        
        if (solarStatus === 'Active') {
            systemStatus.disabled = true;
            systemStatus.value = '';
        } else {
            systemStatus.disabled = false;
        }
    };
    ...
    const validateForm = () => {
        ...
        const serialNumber = document.getElementById('counter_serial').value;
        let isValid = true;
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        // Set up solar status change listener
        const solarStatusSelect = document.getElementById('solar_status');
        if (solarStatusSelect) {
            solarStatusSelect.addEventListener('change', handleSolarStatusChange);
            // Trigger initially to set correct state
            handleSolarStatusChange();
        }
        ...
        document.getElementById('powerConfigForm').addEventListener('submit', function(e) {
            ...
            e.preventDefault(); // For demo purposes only
        });
